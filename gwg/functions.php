...
function html5wp_list_child_pages() 
{ 
    global $post; 
    ...
    if ( $childpages ) {
        $string = '<ul class="sub-nav">' . $childpages . '</ul>';
    }
    echo($string);
}
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('modernizr', get_template_directory_uri() . '/js/lib/modernizr.js', array(), '2.7.1'); // Modernizr
